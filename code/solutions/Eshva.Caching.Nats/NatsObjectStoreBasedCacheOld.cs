...
/// </summary>
[PublicAPI]
public sealed class NatsObjectStoreBasedCacheOld : IBufferDistributedCache {
  /// <summary>
  ...
  /// </exception>
  public NatsObjectStoreBasedCacheOld(
    INatsObjStore cacheBucket,
    ObjectStoreBasedCacheInvalidation cacheInvalidation,
    ILogger<NatsObjectStoreBasedCacheOld>? logger = null) {
    ...
    _logger = logger ?? new NullLogger<NatsObjectStoreBasedCacheOld>();
  }
  ...
  private readonly ILogger<NatsObjectStoreBasedCacheOld> _logger;
}
