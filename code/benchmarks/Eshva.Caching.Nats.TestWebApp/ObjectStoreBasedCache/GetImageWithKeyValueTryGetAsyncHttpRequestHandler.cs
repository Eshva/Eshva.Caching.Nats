...
public class GetImageWithKeyValueTryGetAsyncHttpRequestHandler {
  public GetImageWithKeyValueTryGetAsyncHttpRequestHandler(
    IBufferDistributedCache cache,
    ILogger<GetImageWithKeyValueTryGetAsyncHttpRequestHandler> logger) {
  ...
  private readonly ILogger<GetImageWithKeyValueTryGetAsyncHttpRequestHandler> _logger;
}
