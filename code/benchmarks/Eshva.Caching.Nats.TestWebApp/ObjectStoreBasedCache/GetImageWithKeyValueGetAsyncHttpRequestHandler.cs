...
public class GetImageWithKeyValueGetAsyncHttpRequestHandler {
  public GetImageWithKeyValueGetAsyncHttpRequestHandler(
    IBufferDistributedCache cache,
    ILogger<GetImageWithKeyValueGetAsyncHttpRequestHandler> logger) {
  ...
  private readonly ILogger<GetImageWithKeyValueGetAsyncHttpRequestHandler> _logger;
}
